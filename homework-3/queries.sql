...
SELECT c.company_name as customer, CONCAT(e.last_name, ' ',  e.first_name) as name_employee
FROM orders as o
JOIN customers as c USING(customer_id)
JOIN employees as e USING(employee_id)
JOIN shippers as s ON o.ship_via = s.shipper_id
WHERE e.city=c.city AND c.city='London' AND s.company_name='United Package'
